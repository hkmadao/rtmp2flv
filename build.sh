...
for platform in $platforms; do
    ...
    mkdir -p ./resources/output/sqlite3/rtmp2flv_"${ver}"_"${GOOS_VAR}"_"${GOARCH_VAR}"/resources/output/live
    mkdir -p ./resources/output/sqlite3/rtmp2flv_"${ver}"_"${GOOS_VAR}"_"${GOARCH_VAR}"/resources/output/log
    mkdir -p ./resources/output/sqlite3/rtmp2flv_"${ver}"_"${GOOS_VAR}"_"${GOARCH_VAR}"/resources/static
    ...
    tar -zcvf ./rtmp2flv_"${ver}"_"${GOOS_VAR}"_"${GOARCH_VAR}".tar.gz rtmp2flv_"${ver}"_"${GOOS_VAR}"_"${GOARCH_VAR}"/

    # rm -rf ./rtmp2flv_"${ver}"_"${GOOS_VAR}"_"${GOARCH_VAR}"/
    cd ../../../
done
