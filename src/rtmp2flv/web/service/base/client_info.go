...
func getClientInfoName() string {
	return "ClientInfo"
}

func ClientInfoCreate(e entity.ClientInfo) (i int64, err error) {
	o := orm.NewOrm()
	i, err = o.Insert(&e)
...
func ClientInfoUpdateById(e entity.ClientInfo) (i int64, err error) {
	o := orm.NewOrm()
	i, err = o.Update(&e)
	if err != nil {
...
func ClientInfoDelete(e entity.ClientInfo) (i int64, err error) {
	o := orm.NewOrm()
	i, err = o.Delete(&e)
	if err != nil {
...
func ClientInfoBatchDelete(es []entity.ClientInfo) (i int64, err error) {
	o := orm.NewOrm()
	for _, e := range es {
		_, err = o.Delete(&e)
		if err != nil {
...
func ClientInfoSelectByIds(ids []string) (models []entity.ClientInfo, err error) {
	idsNew := make([]interface{}, 0)
	for _, id := range ids {
		idsNew = append(idsNew, id)
	}
	condition := common.GetInCondition("idClientInfo", idsNew)
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getClientInfoName())
	if err_build != nil {
...
func ClientInfoFindCollectionByCondition(condition common.AqCondition) (models []entity.ClientInfo, err error) {
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getClientInfoName())
	if err_build != nil {
...
func ClientInfoFindOneByCondition(condition common.AqCondition) (model entity.ClientInfo, err error) {
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getClientInfoName())
	if err_build != nil {
	...
	o := orm.NewOrm()
	// execute the raw query string
	models := make([]entity.ClientInfo, 0)
	_, err_query := o.Raw(sqlStr, params...).QueryRows(&models)
	if err_query != nil {
		err = fmt.Errorf("findOneByCondition error: %v", err_make_sql)
		return
...
func ClientInfoFindPageByCondition(aqPageInfoInput common.AqPageInfoInput) (pageInfo common.PageInfo, err error) {
...
func ClientInfoCountByCondition(condition common.AqCondition) (total uint64, err error) {
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getClientInfoName())
	if err_build != nil {
...
func ClientInfoExistsByCondition(condition common.AqCondition) (exist bool, err error) {
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getClientInfoName())
	if err_build != nil {
