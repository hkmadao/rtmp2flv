...
func getCameraRecordName() string {
	return "CameraRecord"
}

func CameraRecordCreate(e entity.CameraRecord) (i int64, err error) {
	o := orm.NewOrm()
	i, err = o.Insert(&e)
...
func CameraRecordUpdateById(e entity.CameraRecord) (i int64, err error) {
	o := orm.NewOrm()
	i, err = o.Update(&e)
	if err != nil {
...
func CameraRecordDelete(e entity.CameraRecord) (i int64, err error) {
	o := orm.NewOrm()
	i, err = o.Delete(&e)
	if err != nil {
...
func CameraRecordBatchDelete(es []entity.CameraRecord) (i int64, err error) {
	o := orm.NewOrm()
	for _, e := range es {
		_, err = o.Delete(&e)
		if err != nil {
...
func CameraRecordSelectByIds(ids []string) (models []entity.CameraRecord, err error) {
	idsNew := make([]interface{}, 0)
	for _, id := range ids {
		idsNew = append(idsNew, id)
	}
	condition := common.GetInCondition("idCameraRecord", idsNew)
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getCameraRecordName())
	if err_build != nil {
...
func CameraRecordFindCollectionByCondition(condition common.AqCondition) (models []entity.CameraRecord, err error) {
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getCameraRecordName())
	if err_build != nil {
...
func CameraRecordFindOneByCondition(condition common.AqCondition) (model entity.CameraRecord, err error) {
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getCameraRecordName())
	if err_build != nil {
...
func CameraRecordFindPageByCondition(aqPageInfoInput common.AqPageInfoInput) (pageInfo common.PageInfo, err error) {
...
func CameraRecordCountByCondition(condition common.AqCondition) (total uint64, err error) {
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getCameraRecordName())
	if err_build != nil {
...
func CameraRecordExistsByCondition(condition common.AqCondition) (exist bool, err error) {
	var querySqlBuilder, err_build = dyn_query.NewQuerySqlBuilder(condition, getCameraRecordName())
	if err_build != nil {
